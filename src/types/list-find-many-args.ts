...
export const listUncheckedCreateInputSchema = z.object({
  id: z.string().optional(),
  createdAt: z.union([z.date(), z.string()]).optional(),
  updatedAt: z.union([z.date(), z.string()]).optional(),
  title: z.string(),
...
export const listCreateArgsSchema = z
  .object({
    data: listUncheckedCreateInputSchema,
  })
  .describe("`create` function of Prisma client API for List model");

// Type inference helpers
export type ListUncheckedCreateInput = z.infer<
  typeof listUncheckedCreateInputSchema
>;
